...
......................................................................*)
  ...
  let remove_listener (evt : 'a event) (i : id) : unit =
    let rec remove_listener' (lst : 'a waiter list) : 'a waiter list =
      match lst with
      | [] -> []
      | h::t -> if h.id = i then evt := ref t ; t
                else h :: remove_listener' t in
    remove_listener' !evt ; ()
  ...
  let remove_listener (evt : 'a event) (i : id) : unit =
    let rec remove_listener' (lst : 'a waiter list) : 'a waiter list =
      match lst with
      | [] -> []
      | h::t -> if h.id = i then t
                else h :: remove_listener' t in
    evt := (remove_listener' !evt) ; ()
...
......................................................................*)
  ...
  let fire_event (evt : 'a event) (arg : 'a) : unit =
    let _ = List.map (fun waiter -> waiter.action arg) !evt in ()
...
remove_listener newswire 0 ;;
remove_listener newswire 1 ;;
...
add_listener publish receive_report ;;
